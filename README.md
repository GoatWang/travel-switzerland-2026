...
> 以下報告保留作歷史參考；目前行程以 [Main Itinerary / 主行程](docs/瑞士旅遊規劃.md) 為準。

| 文件 | 說明 |
|------|------|
| [住宿選項分析](docs/住宿選項分析.md) | 歷史住宿比較與預訂分析 |
| [租車確認與車款比較](docs/租車車款比較報告.md) | 租車比較與 Avis 訂單摘要 |
| [交通成本分析](docs/六人交通成本比較分析.md) | 自駕 vs 火車成本試算 |
